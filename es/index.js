...
var DefaultCalendar = (_temp2 = _class = function (_Component) {
  ...
  function DefaultCalendar() {
    ...
    }, _this.handleSelect = function (selected, event) {
    ...
    }, _this.handleDayMouseEnter = function (selected, event) {
      var onDayMouseEnter = _this.props.onDayMouseEnter;

      if (typeof onDayMouseEnter === 'function') {
        onDayMouseEnter(selected, event);
      }
    }, _this.handleDayMouseDown = function (selected, event) {
      var onDayMouseDown = _this.props.onDayMouseDown;

      if (typeof onDayMouseDown === 'function') {
        onDayMouseDown(selected, event);
      }
    }, _this.handleDayMouseUp = function (selected, event) {
      var onDayMouseUp = _this.props.onDayMouseUp;

      if (typeof onDayMouseUp === 'function') {
        onDayMouseUp(selected, event);
      }
